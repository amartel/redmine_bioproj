...
You will have also to change line 13 of @app/views/bioproj_members/_show.html.erb@ to specify the list of role_id for roles having @:manage_members@ and @:bioproj_members@ permissions
